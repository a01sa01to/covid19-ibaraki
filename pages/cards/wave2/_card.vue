...
import IbarakiCityCard from '@/components/wave2/IbarakiCityMapCard.vue'
...
export default {
  ...
  head() {
    ...
    const ogpImage =
      this.$i18n.locale === 'ja'
        ? `${url}/ogp/wave2/${this.$route.params.card}.png?t=${timestamp}`
        : `${url}/ogp/wave2/${this.$i18n.locale}/${this.$route.params.card}.png?t=${timestamp}`
