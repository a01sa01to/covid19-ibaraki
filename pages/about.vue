  ...
  <div class="About">
    ...
    <static-card>
      ...
      <ul>
        <li>
          <external-link
            :url="$t('https://marketingplatform.google.com/about/analytics/terms/jp/')"
            :icon-size="16"
          >
        ...
        <li>
          <external-link
            :url="$t('https://support.google.com/analytics/answer/6004245?hl=ja')"
            :icon-size="16"
          >
