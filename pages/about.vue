<template>
  <div class="About">
    ...
    <static-card>
      <h2>{{ $t('当サイトの情報について') }}</h2>
      <p>
        {{ $t('当サイトの情報は、以下のサイトから入手・反映しています。') }}
      </p>
      <ul>
        <li>
          <a href="https://www.pref.ibaraki.jp/index.html" target="_blank"  rel="noopener noreferrer">
            {{ $t('茨城県公式サイト') }}
          </a>
        </li>
      </ul>
    ...
    <static-card>
      ...
      <p>
        {{
          $t(
            '当サイトに掲載されている情報の正確性については万全を期していますが、茨城県及び当サイトの管理者は利用者が当サイトの情報を用いて行う一切の行為について責任を負うものではありません。'
          )
        }}
      </p>
      <p>
