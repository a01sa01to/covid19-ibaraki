...
const typeMap: any = {
  ...
  Data: o(
    [
      ...
      {
        json: '(2)#7119（東京消防庁救急相談センター）における発熱等相談件数 ',
        js: 'the27119東京消防庁救急相談センターにおける発熱等相談件数',
        typ: 3.14,
      },
      {
        json: '(3)新規陽性者における接触歴等不明者（人数）',
        js: 'the3新規陽性者における接触歴等不明者人数',
        typ: 3.14,
      },
      {
        json: '(3)新規陽性者における接触歴等不明者（増加比）',
        js: 'the3新規陽性者における接触歴等不明者増加比',
        typ: 3.14,
      },
      {
        json: '(4)PCR・抗原検査（陽性率）',
      ...
      {
        json: '(4)PCR・抗原検査（検査人数）',
        js: 'the4Pcr抗原検査検査人数',
        typ: 3.14,
      },
      {
        json: '(5)救急医療の東京ルールの適用件数',
        js: 'the5救急医療の東京ルールの適用件数',
        typ: 3.14,
      },
