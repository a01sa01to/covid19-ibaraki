...
export class Convert {
  public static toInfectionMedicalcareprovisionStatus(
    json: string
  ): InfectionMedicalcareprovisionStatus {
    return cast(JSON.parse(json), r('InfectionMedicalcareprovisionStatus'))
  }

  public static infectionMedicalcareprovisionStatusToJson(
    value: InfectionMedicalcareprovisionStatus
  ): string {
    return JSON.stringify(
      uncast(value, r('InfectionMedicalcareprovisionStatus')),
      null,
      2
    )
  }
