        ...
        <template #description>
          <ul>
            <li>
              {{
                $t(
                  '「ワクチン接種記録システム（VRS）」への報告を居住地の都道府県別に国が集計し、公表したものに基づき作成。県が公表する「ワクチン接種円滑化システム（V-sys）」によるデータではないため、県が公表するデータとずれが生じる場合がある。'
                )
              }}
            </li>
            <li>
...
import Chart from '@/components/VaccineSummaryChart.vue'
